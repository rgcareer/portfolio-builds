// Line-oriented helpers over the textified page. Everything is 1-based line numbers so a
// finding can cite "line N" and a test can verify the verbatim excerpt sits on that line.
